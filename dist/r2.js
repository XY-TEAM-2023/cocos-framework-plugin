 ...
 */
async function checkBundleChanged(client, bucket, entry) {
    var _a, _b, _c, _d;
    const isApp = entry.bundleName === '📦 app';
    try {
        ...
        if (isApp) {
            ...
            try {
                const resp = await client.send(new client_s3_1.GetObjectCommand({ Bucket: bucket, Key: versionKey }));
        ...
        try {
            ...
            const text = await ((_c = resp.Body) === null || _c === void 0 ? void 0 : _c.transformToString('utf-8'));
            if (!text)
                return 'new';
            remoteManifest = text;
        }
        catch (e) {
            if (e.name === 'NoSuchKey' || ((_d = e.$metadata) === null || _d === void 0 ? void 0 : _d.httpStatusCode) === 404) {
                return 'new';
            }
            throw e;
        }
...
exports.checkBundleChanged = checkBundleChanged;
// ==================== 文件上传 ====================
