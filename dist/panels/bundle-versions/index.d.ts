...
export declare const methods: {
    setBundlePlatforms(jsonStr: string): void;
    setBundleTree(jsonStr: string): void;
    setBundleVersionList(jsonStr: string): void;
    switchBundleVersionResult(success: boolean, msg: string): void;
};
