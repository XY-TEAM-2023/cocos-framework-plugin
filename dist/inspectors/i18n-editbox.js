 ...
 */
async function syncEditBoxPlaceholder(nodeUuid, i18nCompPath, key) {
    var _a, _b, _c, _d;
    ...
    try {
        ...
        for (let i = 0; i < nodeDump.__comps__.length; i++) {
            if (((_a = nodeDump.__comps__[i]) === null || _a === void 0 ? void 0 : _a.type) === 'cc.EditBox') {
        ...
        if (!editBoxCompPath)
            return;
        // 已是目标值时跳过
        const currentVal = (_d = (_c = (_b = nodeDump.__comps__.find(c => (c === null || c === void 0 ? void 0 : c.type) === 'cc.EditBox')) === null || _b === void 0 ? void 0 : _b.value) === null || _c === void 0 ? void 0 : _c.placeholder) === null || _d === void 0 ? void 0 : _d.value;
        if (currentVal === text)
            return;
        // @ts-ignore
...
//# sourceMappingURL=i18n-editbox.js.map